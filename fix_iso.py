...
pattern = re.compile(r'<div className="absolute w-\[2200px\] flex justify-center items-center perspective-\[2500px\]">.*?</div>\s*</div>\s*</div>\s*\{/\* 3\. EXPERIENCE FLOW', re.DOTALL)

new_isometric = """<div className="absolute w-[2200px] flex justify-center items-center perspective-[2500px]">
...
if pattern.search(content):
    content = pattern.sub(new_isometric, content)
