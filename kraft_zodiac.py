        ...
        <section id="zodiac" className="relative w-full py-32 bg-[#F9F7F3] overflow-hidden">
           ...
           <div className="max-w-[1400px] mx-auto relative z-20 flex flex-col items-center">
              ...
              <div className="flex flex-col items-center mb-12 text-center px-6">
                  <div className="text-[#8C8377] text-sm md:text-base mb-4 uppercase font-['Quicksand'] tracking-[0.2em] font-bold">
                      07. Zodiac Collections
                  </div>
                  
                  {{/* Simplified, Elegant Typography */}}
                  <h2 className="font-['Fredoka'] text-[60px] md:text-[90px] text-[#4A4238] leading-none mb-6 text-center font-medium">
                      ZODIAC
                  </h2>
                  
                  <p className="max-w-2xl text-base md:text-lg text-[#736B60] font-['Quicksand'] font-medium leading-relaxed px-4">
              ...
              {{/* INTERACTIVE PAPER STACK - WARM BEIGE/KRAFT VIBE */}}
              <div className="relative w-full max-w-[1100px] h-[650px] md:h-[800px] mx-auto mt-4 perspective-[1200px]">
                  {{{js_array_str}.map((page, idx) => {{
                      ...
                      return (
                          <div 
                              key={{idx}}
                              className="absolute inset-0 bg-[#FDFCF9] rounded-[20px] border border-[#EBE6DD] p-8 md:p-14 transition-all duration-[900ms] ease-[cubic-bezier(0.25,1,0.5,1)] overflow-hidden flex flex-col shadow-[0_20px_60px_rgba(90,80,70,0.08)]"
                              style={{{{
                          ...
                          >
                              ...
                              <div className="w-full flex justify-between items-center mb-8 border-b border-[#EBE6DD] pb-6 shrink-0">
                                  <h3 className="font-['Fredoka'] font-medium text-3xl md:text-4xl text-[#4A4238] tracking-wide">
                                      {{page.title}}
                                  </h3>
                                  <button 
                                      onClick={{() => setActiveZodiacPage(prev => (prev + 1) % 5)}}
                                      className="group flex items-center gap-2 font-['Quicksand'] font-semibold text-[#8C8377] hover:text-[#4A4238] transition-colors cursor-pointer text-sm md:text-base px-4 py-2"
                                  >
