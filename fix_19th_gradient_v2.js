...
const newTitle = `className="font-['Fredoka'] text-[60px] md:text-[90px] font-black text-transparent bg-clip-text bg-gradient-to-b from-[#B48CF5] to-[#6A3CC9] leading-none mb-6 pb-2" style={{ filter: 'drop-shadow(0px 0px 10px rgba(255,255,255,1))' }}`;
...
code = code.replace(regexSubheading, (match, p1) => {
    ...
    return `className="font-['Fredoka'] text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-b from-[#B48CF5] to-[#6A3CC9] mb-10 tracking-wide${centerClass}" style={{ filter: 'drop-shadow(0px 0px 8px rgba(255,255,255,0.9))' }}`;
});
