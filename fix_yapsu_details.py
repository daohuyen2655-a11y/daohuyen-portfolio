...
new_yapsu = """
        {/* ─── 01. YAPSU AI (THE "WOW" FACTOR - REFINED DETAILS) ─── */}
        <section id="yapsu-ai" className="relative w-full py-32 bg-[#FAF9F6] text-[#1E293B] overflow-hidden font-sans">
           ...
           <style dangerouslySetInnerHTML={{__html: `
              ...
              .reflect-glass {
                 -webkit-box-reflect: below 8px linear-gradient(transparent 70%, rgba(255,255,255,0.5));
              }
           `}} />

           {/* Ethereal Glowing Background Orbs (Yapsu Amber/Orange) */}
           <div className="absolute top-0 right-0 w-[800px] h-[800px] bg-gradient-to-br from-orange-400/20 to-amber-300/10 rounded-full blur-[150px] pointer-events-none z-0"></div>
           <div className="absolute top-[40%] left-[-10%] w-[600px] h-[600px] bg-gradient-to-tr from-blue-400/15 to-cyan-300/10 rounded-full blur-[120px] pointer-events-none z-0"></div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 relative z-20 flex flex-col">
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between mb-48 gap-12 w-full">
                 ...
                 <div className="w-full lg:w-[45%] flex flex-col items-start pt-10">
                    ...
                    <div className="w-[180px] h-[180px] rounded-[45px] shadow-[0_30px_60px_rgba(249,115,22,0.2)] shrink-0 overflow-hidden bg-white border border-white hover:scale-105 transition-transform duration-500 relative group z-10">
                 ...
                 <div className="w-full lg:w-[55%] h-[750px] relative flex justify-center items-center perspective-[2000px]">
                    ...
                    <div className="absolute top-[80px] right-[80px] w-[300px] h-[630px] rounded-[60px] p-[10px] shadow-[0_40px_80px_rgba(0,0,0,0.15)] bg-gradient-to-br from-gray-100 to-gray-300 border border-white" 
                       ...
                       <div className="w-full h-full bg-black rounded-[50px] overflow-hidden relative border-[6px] border-black shadow-[inset_0_0_15px_rgba(0,0,0,0.5)]">
                          ...
                          <img src="/assets/portfolio_assets/Yapsu AI/snapshots/roadmap_05.jpg" className="w-full h-full object-cover" />
                       </div>
                    </div>
                    ...
                    <div className="absolute top-[180px] left-[60px] w-[320px] h-[670px] rounded-[60px] p-[10px] shadow-[[-30px_50px_100px_rgba(0,0,0,0.25)]] bg-gradient-to-br from-white to-gray-200 border border-white z-10" 
                       ...
                       <div className="w-full h-full bg-black rounded-[50px] overflow-hidden relative border-[6px] border-black shadow-[inset_0_0_15px_rgba(0,0,0,0.5)]">
                          ...
                          <img src="/assets/portfolio_assets/Yapsu AI/snapshots/onboard_04.jpg" className="w-full h-full object-cover" />
                       </div>
                    </div>
                 </div>
              </div>
              ...
              <div className="w-full flex flex-col items-center mb-48 pt-10">
                 <h3 className="font-['Fredoka'] text-[55px] font-bold text-[#1A202C] text-center mb-4 tracking-tight z-30 relative">Experience Flow</h3>
                 
                 <div className="relative w-full h-[750px] flex justify-center items-center overflow-visible z-20 pointer-events-none mt-10">
                    <div className="absolute w-[1200px] h-[1200px] flex justify-center items-center perspective-[2500px] pointer-events-auto">
                       <div className="flex gap-[60px] transform rotate-x-[55deg] rotate-z-[-35deg] scale-[1.1] translate-y-[40px]">
                          
                          {/* Left Column (Lower) */}
                          <div className="flex flex-col gap-[60px] translate-y-[80px]" style={{ animation: 'float-iso 6s ease-in-out infinite' }}>
                             {["roleplay_05.jpg", "roadmap_10.jpg"].map((src, i) => (
                          ...
                          <div className="flex flex-col gap-[60px] -translate-y-[40px]" style={{ animation: 'float-iso 7s ease-in-out infinite 0.5s' }}>
                             {["onboard_09.jpg", "roleplay_15.jpg", "roadmap_15.jpg"].map((src, i) => (
                          ...
                          <div className="flex flex-col gap-[60px] translate-y-[40px]" style={{ animation: 'float-iso 6.5s ease-in-out infinite 1s' }}>
                             {["roadmap_07.jpg", "roleplay_18.jpg"].map((src, i) => (
              ...
              <div className="w-full flex flex-col items-center mb-48 pt-10">
                 <div className="w-full max-w-[800px] text-center mb-16">
                    ...
                    <p className="text-xl text-gray-500">A comprehensive view of the most distinct and colorful crafted screens.</p>
                 </div>
                 
                 <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4 w-full px-2">
                    {[
                       "onboard_04.jpg",   // Vibrant green mascot
                       "roadmap_10.jpg",   // Clean white roadmap
                       "roleplay_15.jpg",  // Chat interface light
                       "onboard_09.jpg",   // Bright blue background
                       "roadmap_05.jpg",   // Progress drill
                       "roleplay_18.jpg",  // Darker/distinct chat
                       "roadmap_15.jpg",   // Detailed list view
                       "onboard_20.jpg",   // Setup screen
                       "roleplay_05.jpg",  // Tutor selection
                       "roadmap_07.jpg",   // Achievement/drill
                       "roleplay_10.jpg",  // Modal popups
                       "onboard_15.jpg"    // Welcome/splash vibrant
                    ].map((src, i) => (
                       <div key={`flat-${i}`} className="w-full aspect-[9/19] rounded-[24px] overflow-hidden shadow-md bg-white hover:shadow-2xl hover:scale-[1.03] transition-all duration-300 cursor-pointer border border-gray-200">
                          <img src={`/assets/portfolio_assets/Yapsu AI/snapshots/${src}`} className="w-full h-full object-cover" />
                       </div>
                    ))}
                 </div>
              ...
              {/* 4. INTERACTIVE PROTOTYPES (TITLES ON TOP, CLEAR REFLECTIONS) */}
                 ...
                 <div className="flex flex-col lg:flex-row justify-center items-center gap-20 w-full mt-10">
                    ...
                    {[
                       ...
                       <div key={idx} className="flex flex-col items-center group">
                          {/* Title moved to top to prevent reflection overlap */}
                          <h4 className="font-['Fredoka'] text-3xl mb-10 text-[#1A202C] font-bold tracking-wide drop-shadow-sm">{vid.title}</h4>
                          
                          <div className="relative w-[320px] h-[670px] bg-gradient-to-b from-[#ffffff] to-[#e5e5e5] rounded-[60px] p-[10px] shadow-[0_40px_80px_rgba(0,0,0,0.15)] border border-white reflect-glass transition-transform duration-500 hover:-translate-y-4">
