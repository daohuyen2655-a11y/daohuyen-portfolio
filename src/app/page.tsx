      ...
      {introVisible && (
        <div className={`fixed inset-0 z-[100] bg-[#FDFCEE] flex flex-col items-center justify-center transition-transform duration-1000 ease-[cubic-bezier(0.76,0,0.24,1)] ${entered ? '-translate-y-full' : 'translate-y-0'}`}>
         ...
         <div className="relative z-10 flex flex-col items-center">
            <h1 className="text-[55px] sm:text-[80px] md:text-[100px] lg:text-[120px] mb-8 text-center leading-[1.1] rotate-[-2deg] font-['Fredoka'] font-black text-stroke-white-shadow-orange animate-[fade-in-up_0.8s_ease-out_forwards] cursor-default hover:scale-105 hover:rotate-2 transition-transform duration-500 opacity-0 mx-auto md:whitespace-nowrap">
                    ...
                    <div className="relative shrink-0 rotate-[-3deg] z-20">
                       <div className="bg-white p-4 pb-12 rounded-[16px] shadow-[8px_8px_0px_rgba(0,0,0,0.1)] border-[4px] border-white/50 w-[160px] md:w-[240px]">
                           <div className="relative w-full aspect-[3/4] overflow-hidden rounded-[8px]">
                               <img loading="eager" fetchPriority="high" src="/assets/huyen-dao-avatar-2.jpg" className="absolute max-w-none" style={{ width: '270%', height: 'auto', left: '-52%', top: '-75%' }} alt="Avatar" />
                           </div>
                       </div>
              ...
              <div className="flex flex-col lg:flex-row items-center justify-between mb-32 gap-16 w-full max-w-[1400px] mx-auto pt-10">
                 <div className="w-full lg:w-[45%] flex flex-col items-start pt-10">
                    ...
                    <div className="w-[160px] h-[160px] rounded-[36px] shadow-[0_15px_40px_rgba(0,0,0,0.08)] shrink-0 overflow-hidden bg-white border border-gray-100 hover:-translate-y-2 transition-transform duration-500">
                       <img loading="lazy"  src="/assets/portfolio_assets/Yapsu%20AI/yapsu_icon_premium.jpg" className="w-full h-full object-cover" />
                    </div>
                 </div>
    ...
    <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
        ...
        <div className="w-full mb-32 flex flex-col items-center">
            ...
            <div className="relative w-full max-w-5xl rounded-[24px] overflow-hidden border-2 border-cyan-500/50 shadow-[0_0_40px_rgba(34,211,238,0.2)]">
                <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202026/KEY%20VISUAL/cover%20tbth.jpg" alt="Chinese Debate Key Visual Cover" className="w-full h-auto block" />
            </div>
            ...
            <div className="relative -mt-16 w-32 h-32 md:w-40 md:h-40 rounded-full p-1 bg-gradient-to-br from-cyan-400 to-blue-600 shadow-[0_0_30px_rgba(34,211,238,0.5)] z-10 group hover:-translate-y-2 transition-transform duration-300">
                <div className="w-full h-full rounded-full overflow-hidden bg-[#06112E]">
                    <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202026/KEY%20VISUAL/avatar-01.jpg" alt="Chinese Debate Avatar" className="w-full h-full object-cover" />
                </div>
            </div>
        </div>
            ...
            <div className="w-full max-w-5xl flex flex-col gap-16">
                ...
                <div className="flex flex-col items-center gap-5">
                    <div className="relative group w-full rounded-[24px] overflow-hidden border-2 border-cyan-900/60 hover:border-cyan-400/80 transition-colors duration-500 shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                        <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202026/Print%20&%20Event%20Applications/Backdrop-01.jpg" alt="Backdrop Design" className="w-full h-auto block group-hover:scale-[1.02] transition-transform duration-700" />
                    </div>
                ...
                <div className="flex flex-col items-center gap-5">
                    <div className="relative group w-full max-w-3xl mx-auto rounded-[24px] overflow-hidden border-2 border-cyan-900/60 hover:border-cyan-400/80 transition-colors duration-500 shadow-[0_0_30px_rgba(34,211,238,0.1)]">
                        <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202026/Print%20&%20Event%20Applications/TICKET.jpg" alt="Event Ticket" className="w-full h-auto block group-hover:scale-[1.02] transition-transform duration-700 drop-shadow-xl" />
                    </div>
            ...
            <div className="columns-2 lg:columns-3 gap-4 md:gap-6 w-full max-w-7xl mx-auto">
                ...
                {[
                    ...
                    <div key={idx} className="relative rounded-[20px] overflow-hidden border-2 border-blue-900/60 group hover:border-cyan-400/80 transition-colors duration-300 shadow-md break-inside-avoid mb-6 inline-block w-full">
                        <img loading="lazy"  src={`/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202026/Social%20Posts/${filename}`} alt={filename.replace('.jpg', '')} className="w-full h-auto block group-hover:scale-105 transition-transform duration-500" />
                    </div>
                ))}
            </div>
        </div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-32 flex flex-col items-center">
                  ...
                  <div className="relative w-full max-w-5xl rounded-[32px] overflow-hidden border-[4px] border-white shadow-[0_20px_50px_rgba(59,91,53,0.2)] group">
                      <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/CC%20FTU%20Gen%2020%20Recruitment/KEY%20VISUAL/cover%20tuyển%20gen.jpg" alt="Gen 20 Key Visual" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  ...
                  <div className="relative -mt-20 w-32 h-32 md:w-44 md:h-44 rounded-full p-1 bg-white shadow-xl z-10 group hover:-translate-y-2 transition-transform duration-300 ">
                      <div className="w-full h-full rounded-full overflow-hidden bg-[#D9EBCB]">
                          <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/CC%20FTU%20Gen%2020%20Recruitment/KEY%20VISUAL/avt%20tuyển%20gen.jpg" alt="Gen 20 Avatar" className="w-full h-full object-cover" />
                      </div>
                  </div>
              </div>
              ...
              <div className="w-full mb-32 flex flex-col items-center">
                  ...
                  <div className="w-full max-w-lg flex flex-col items-center gap-6">
                      <div className="relative group w-full rounded-[24px] overflow-hidden border-[6px] border-white shadow-[0_15px_40px_rgba(59,91,53,0.15)] hover:shadow-[0_25px_50px_rgba(59,91,53,0.25)] transition-all duration-500 ">
                          <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/CC%20FTU%20Gen%2020%20Recruitment/Print%20&%20Event%20Applications/frame.jpg" alt="Avatar Frame" className="w-full h-auto block group-hover:scale-[1.02] transition-transform duration-700" />
                      </div>
                      ...
                      <div className="relative w-full h-[400px] sm:h-[450px] md:h-[550px] flex justify-center items-center overflow-visible transform scale-90 md:scale-100" style={{ maskImage: "linear-gradient(to right, transparent, black 8%, black 92%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 8%, black 92%, transparent)" }}>
                          {[
                              ...
                              return (
                                  ...
                                  >
                                      <img loading="lazy"  src={`/assets/portfolio_assets/CC%20FTU/CC%20FTU%20Gen%2020%20Recruitment/SOCIAL%20POST/${filename}`} alt={filename.replace('.jpg', '')} className="max-h-[260px] md:h-[420px] md:max-h-none w-auto max-w-[82vw] md:max-w-none block object-contain" />
                                  </div>
                              );
                          })}
                      </div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-32 flex flex-col items-center">
                  ...
                  <div className="relative w-full max-w-5xl rounded-[32px] overflow-hidden border-[4px] border-white shadow-[0_20px_50px_rgba(134,101,195,0.2)] group">
                      <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/CC%20FTU%2019th%20Anniversary/Key%20Visual/cover%20tím.jpg" alt="19th Anniversary Key Visual" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  
                  {/* Avatar Badge */}
                  <div className="relative -mt-20 w-32 h-32 md:w-44 md:h-44 rounded-full p-1 bg-white shadow-xl z-10 group hover:-translate-y-2 transition-transform duration-300">
                      <div className="w-full h-full rounded-full overflow-hidden bg-[#E3D5F2]">
                          <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/CC%20FTU%2019th%20Anniversary/Key%20Visual/AVT%20tím.jpg" alt="19th Avatar" className="w-full h-full object-cover" />
                      </div>
                  </div>
              </div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-32 flex flex-col items-center">
                  ...
                  <div className="relative w-full max-w-5xl rounded-[32px] overflow-hidden border-[4px] border-[#D4AF37] shadow-[0_0_40px_rgba(212,175,55,0.3)] group">
                      <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202025/KEY%20VISUAL/cover%20tbth1.jpg" alt="Debate 2025 Key Visual" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  ...
                  <div className="relative -mt-20 w-32 h-32 md:w-44 md:h-44 rounded-full p-1 bg-[#D4AF37] shadow-[0_0_30px_rgba(212,175,55,0.4)] z-10 group hover:-translate-y-2 transition-transform duration-300">
                      <div className="w-full h-full rounded-full overflow-hidden bg-[#231710]">
                          <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202025/KEY%20VISUAL/AVATAR%20TBTH.jpg" alt="Debate Avatar" className="w-full h-full object-cover" />
                      </div>
                  </div>
              </div>
                  ...
                  <div className="w-full max-w-5xl flex flex-col gap-16">
                      <div className="flex flex-col items-center gap-5">
                          <div className="relative group w-full rounded-[24px] overflow-hidden border-2 border-[#D4AF37] shadow-[0_0_20px_rgba(212,175,55,0.2)] hover:border-[#F3E5AB] transition-colors duration-500">
                              <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202025/Print%20&%20Event%20Applications/BACKDROP.jpg" alt="Event Backdrop" className="w-full h-auto block group-hover:scale-[1.02] transition-transform duration-700" />
                          </div>
                  ...
                  <div className="relative w-full h-[400px] sm:h-[450px] md:h-[550px] flex justify-center items-center overflow-visible transform scale-90 md:scale-100" style={{ maskImage: "linear-gradient(to right, transparent, black 8%, black 92%, transparent)", WebkitMaskImage: "linear-gradient(to right, transparent, black 8%, black 92%, transparent)" }}>
                      {[
                          ...
                          return (
                              ...
                              >
                                  <img loading="lazy"  src={`/assets/portfolio_assets/CC%20FTU/Chinese%20Debate%202025/Social%20Posts/${filename}`} alt={filename.replace('.jpg', '')} className="max-h-[260px] md:h-[420px] md:max-h-none w-auto max-w-[82vw] md:max-w-none block object-contain" />
                              </div>
                          );
                      })}
                  </div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-24 flex flex-col items-center">
                  ...
                  <div className="relative w-full max-w-5xl rounded-[32px] overflow-hidden border-[4px] border-white shadow-[0_20px_50px_rgba(88,179,211,0.2)] group">
                      <img loading="lazy"  src="/assets/portfolio_assets/CC%20FTU/Talkshow/KEY%20VISUAL/cover%20nè%2022.04.05.jpg" alt="Talkshow Key Visual" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  ...
                  <div className="flex flex-row md:flex-wrap justify-start md:justify-center overflow-x-auto md:overflow-visible snap-x snap-mandatory gap-4 md:gap-6 w-full max-w-[1200px] mx-auto px-6 md:px-0 pb-12 md:pb-0 scrollbar-hide">
                      {[
                          ...
                          <div key={idx} className="relative rounded-[16px] overflow-hidden border-[4px] border-white shadow-[0_15px_30px_rgba(88,179,211,0.15)] group hover:border-[#8DD1E8] transition-colors duration-300 w-[85%] sm:w-[calc(50%-12px)] lg:w-[calc(33.333%-16px)] flex-shrink-0 snap-center">
                              <img loading="lazy" src={`/assets/portfolio_assets/CC%20FTU/Talkshow/SOCIAL%20POST/${filename}`} alt={filename.replace('.jpg', '')} className="w-full h-auto block group-hover:scale-105 transition-transform duration-500"  />
                          </div>
                      ))}
                  </div>
                                  ...
                                  <div style={{ display: 'flex', flexWrap: 'nowrap', overflowX: 'auto', paddingBottom: '16px', scrollbarWidth: 'none', msOverflowStyle: 'none' } as any} className="zodiac-scroll-container gap-4 sm:gap-6">
                                      {page.images.map((img, i) => (
                                          <div key={i} style={{ flexShrink: 0, borderRadius: '12px', overflow: 'hidden', border: '2px solid #F2EFEA', background: 'white', boxShadow: '0 8px 24px rgba(0,0,0,0.06)' }} className="h-[380px] sm:h-[450px] md:h-[580px] hover:scale-[1.02] transition-transform duration-300">
                                              <img loading="lazy" src={img} alt="Zodiac Collection" style={{ height: '100%', width: 'auto', display: 'block' }}  />
                                          </div>
                                      ))}
                                  </div>
                              </div>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-32">
                  ...
                  <div className="flex flex-row flex-wrap gap-8 justify-center items-start">
                      ...
                      <div className="flex flex-col items-center gap-4">
                          <div className="rounded-[24px] overflow-hidden border-[4px] border-white shadow-lg group hover:border-[#3A7FB5] transition-colors duration-300" style={{ height: '452px' }}>
                              <img loading="lazy"  src="/assets/portfolio_assets/PAINTASO/Print%20&%20Event%20Applications/TEMPLATES%20STORY.jpg" alt="Templates Story" style={{ height: '100%', width: 'auto', display: 'block' }} className="group-hover:scale-105 transition-transform duration-500" />
                          </div>
                  ...
                  <div className="columns-2 gap-4 md:gap-6 w-full max-w-4xl mx-auto">
                      ...
                      {[
                          ...
                          <div key={idx} className="relative rounded-[20px] overflow-hidden border-[4px] border-white group hover:border-[#3A7FB5] transition-colors duration-300 shadow-md break-inside-avoid mb-6 inline-block w-full" style={{ lineHeight: 0 }}>
                              <img loading="lazy" src={`/assets/portfolio_assets/PAINTASO/SOCIAL%20POSTS/${filename}`} alt={filename.replace('.jpg', '')} style={{ width: '100%', display: 'block' }}  className="group-hover:scale-105 transition-transform duration-500" />
                          </div>
                      ))}
                  </div>
              </div>
