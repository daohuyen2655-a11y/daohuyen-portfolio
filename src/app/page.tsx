      ...
      <div className="">
        ...
        <section id="home" className="relative w-full min-h-screen flex flex-col items-center justify-center pt-24 pb-32 z-10 bg-[#FAF4E1] overflow-hidden">
          ...
          <div className="relative z-30 inline-flex flex-col items-center mt-12 group/folder transform -rotate-[8deg] skew-x-[-2deg]">
             ...
             */}
             <div className={`relative bg-[#FFE885] rounded-[24px] md:rounded-[30px] border-[6px] md:border-[8px] border-white shadow-[0_15px_40px_rgba(0,0,0,0.06)] px-16 md:px-32 py-20 md:py-32 flex items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover/folder:-translate-y-2 group-hover/folder:shadow-[0_25px_50px_rgba(0,0,0,0.1)] opacity-0 ${entered ? 'animate-layer-up delay-300' : ''}`}>
                          ...
                          >
                              ...
                              <div className="w-full">
                                  {(page.title === "MÁC 1" || page.title === "MÁC 3") ? (
                                      <div style={{ display: 'flex', flexWrap: 'wrap', justifyContent: 'flex-start', gap: '12px', maxWidth: '430px' }}>
                                          {page.images.map((img, i) => (
                                              <div key={i} style={{ width: '130px', borderRadius: '8px', overflow: 'hidden', border: '1px solid #F2EFEA', background: 'white', boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
           ...
           <div className="max-w-[1400px] mx-auto px-6 sm:px-10 relative z-20 flex flex-col">
              ...
              <div className="w-full mb-32 flex flex-col items-center">
                  ...
                  <div className="relative w-full max-w-5xl rounded-[32px] overflow-hidden border-[4px] border-white shadow-[0_20px_50px_rgba(58,127,181,0.2)] group">
                      <img src="/assets/portfolio_assets/PAINTASO/KEY VISUAL/COVER.jpg" alt="Paintaso Key Visual" className="w-full h-auto block group-hover:scale-105 transition-transform duration-700" />
                  </div>
                  {/* Avatar Badge */}
                  <div className="relative -mt-20 w-32 h-32 md:w-44 md:h-44 rounded-full p-1 bg-white shadow-xl z-10 group hover:-translate-y-2 transition-transform duration-300">
                      <div className="w-full h-full rounded-full overflow-hidden bg-[#D0EEFA]">
                          <img src="/assets/portfolio_assets/PAINTASO/KEY VISUAL/AVATAR.jpg" alt="Paintaso Avatar" className="w-full h-full object-cover" />
                      </div>
                  </div>
              </div>
                  ...
                  <div className="flex flex-row flex-wrap gap-8 justify-center items-start">
                      ...
                      <div className="flex flex-col items-center gap-4">
                          <div className="rounded-[24px] overflow-hidden border-[4px] border-white shadow-lg group hover:border-[#3A7FB5] transition-colors duration-300" style={{ height: '452px' }}>
                              <img src="/assets/portfolio_assets/PAINTASO/Print & Event Applications/FLYER MỞ ĐƠN.jpg" alt="Flyer Mở Đơn" style={{ height: '100%', width: 'auto', display: 'block' }} className="group-hover:scale-105 transition-transform duration-500" />
                          </div>
                      ...
                      <div className="flex flex-col items-center gap-4">
                          <div className="rounded-[24px] overflow-hidden border-[4px] border-white shadow-lg group hover:border-[#3A7FB5] transition-colors duration-300" style={{ height: '452px' }}>
                              <img src="/assets/portfolio_assets/PAINTASO/Print & Event Applications/TEMPLATES STORY.png" alt="Templates Story" style={{ height: '100%', width: 'auto', display: 'block' }} className="group-hover:scale-105 transition-transform duration-500" />
                          </div>
              ...
              <div className="w-full mb-10">
                  ...
                  <div className="columns-1 md:columns-2 gap-6 w-full max-w-4xl mx-auto">
                      ...
                      <div className="relative rounded-[20px] overflow-hidden border-[4px] border-white group shadow-lg break-inside-avoid mb-6 inline-block w-full" style={{ lineHeight: 0 }}>
                          <video src="/assets/portfolio_assets/PAINTASO/SOCIAL POSTS/SOCIAL POST (GIF) AI SẼ ĐI CÙNG BẠN ĐẾN WORKSHOP.mov" autoPlay muted loop playsInline style={{ width: '100%', display: 'block' }} />
                      </div>
                      {/* Image posts */}
                      {[
                          ...
                          <div key={idx} className="relative rounded-[20px] overflow-hidden border-[4px] border-white group hover:border-[#3A7FB5] transition-colors duration-300 shadow-md break-inside-avoid mb-6 inline-block w-full" style={{ lineHeight: 0 }}>
                              <img src={`/assets/portfolio_assets/PAINTASO/SOCIAL POSTS/${filename}`} alt={filename.replace('.png', '')} style={{ width: '100%', display: 'block' }} loading="lazy" className="group-hover:scale-105 transition-transform duration-500" />
                          </div>
                      ))}
                  </div>
              </div>
        ...
        <footer id="contact" className="relative w-full min-h-screen flex flex-col items-center justify-center pt-24 pb-32 z-10 bg-[#FAF4E1] overflow-hidden">
          ...
          <div className="relative z-30 inline-flex flex-col items-center mt-12 group/folder transform -rotate-[8deg] skew-x-[-2deg]">
             ...
             {/* 
                ...
                This makes the folder taller, giving horizontal elements MUCH more room to spread vertically.
             */}
             <div className={`relative bg-[#FFE885] rounded-[24px] md:rounded-[30px] border-[6px] md:border-[8px] border-white shadow-[0_15px_40px_rgba(0,0,0,0.06)] px-16 md:px-32 py-16 md:py-24 flex items-center justify-center transition-all duration-700 ease-[cubic-bezier(0.34,1.56,0.64,1)] group-hover/folder:-translate-y-2 group-hover/folder:shadow-[0_25px_50px_rgba(0,0,0,0.1)] opacity-0 ${entered ? 'animate-layer-up delay-300' : ''}`}>
